...
@Service
public class SimpleBoardNameWithUserListService {
	@Autowired
	...
	public Object service(Object args) {
		Object result = null;
		try {
			result = simpleBoardNameWithUserDAO.selectALLByBoard_Id((SimpleBoardNameWithUser)args);
		} catch (Exception e) {
			result = null;
			System.out.println("SimpleBoardNameWithUserListService 예외처리 부분");
			e.printStackTrace();
		}
		return result;
	}
